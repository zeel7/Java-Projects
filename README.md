...
- Netbeans IDE : to write programs
- XAMPP : to link database to our Application

The source code of this project is written in **Java**. So, you'll require **WAMP/XAMPP/MAMP** to run this project.
